...
const AppLayout: React.FC<Props> = (props) => {
  ...
  const themeState = useSelector<RootState, ThemeOption>(
      ...
      <Layout className="site-layout">
        ...
        <Content>
          <div className="page-title-box">
            <Row align="middle">
              <Col span={18}>
                ...
                <div className="page-title-box-remark">
                  Welcome to Xoric Dashboard
                </div>
              </Col>
              <Col span={6}>
                <div style={{ textAlign: 'right' }}>
                  <Button type="default" shape="round" icon={<SettingOutlined />}>
                    更多选项
                  </Button>
                </div>
              </Col>
          ...
          <div className="site-layout-content-background" style={{ minHeight: 360 }}>
            <div style={{ width: '100%', padding: '24px 24px 12px 24px', height: '100%' }}>
              <RouterMap></RouterMap>
            </div>
          </div>
        </Content>
